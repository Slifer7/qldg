        ...
        <ul id="menu">
		  <?php
			if (0 != strcmp( "admin",
				...
				echo "<li id='history'><a href='controlpanel.php?action=history'>Nhập liệu quá khứ</a></li>";
				$choice = "visitman";
			}
		  if (0 == strcmp( "admin",
						   strtolower($result->Room)
      ...
      <div class="sidebar">
        ...
        <img src="img/user.png" style="padding-left: 2px; padding-right: 2px;" /> <a id="txtUsername" href="profile.php"><b><?php echo $_SESSION["LOGIN_INFO"]->Username; ?></b></a><br/>
				...
				if (0 == strcmp( "admin",
					...
					echo "<img src='img/summary.png' style='position: relative; padding-top: 5px; top: 3px;'/> <a href='Summary' onclick='return generateSummaryReport_Click();'>Báo cáo tổng kết</a><br/>";
				}
				?>
				<br/>
